...
public class DataGridAutomationImpl extends ListBaseAutomationImpl 
{
    ...
    override public function getItemAutomationIndex(delegate:IAutomationObject):String
    {
		...
		// http://bugs.adobe.com/jira/browse/FLEXENT-1183
		// it was observed that when the item form the DG is moved out as a part of drag Drop Move operations, 
		// the moved item was still referrred in the the item renderers list and it is still part of the 
		// rowMap which is used in the itemRendererToIndex , but not a part of the columnMap.
		// we dont need to really consider this object, so not agin spending effort in calculating the automationName.
		// so just returning "".
