...
class HTTPOperation extends AbstractOperation 
{
	...
	/**
	 * Provides convenient access to the HTTPService on which the HTTPOperation
     * is being invoked. Note that the service cannot be changed after
     * the HTTPOperation is constructed.
	 */
	...
	/**
	 * Override specific to HTTPOperation. The containing service of an HTTPOperation
	 * is not an implementation of mx.rpc.AbstractService, so this will always be
	 * null. This override is necessary so that a warning can be logged. To get the
	 * containing instance of HTTPService from an HTTPOperation, use
	 * HTTPOperation.httpService.
	 */
